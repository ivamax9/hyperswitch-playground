...
macro_rules! default_impl_connector_access_token {
    ($($path:ident::$connector:ident),*) => {
        $(
            impl api::ConnectorAccessTokenSuffix for $path::$connector {}
        )*
    };
}

default_impl_connector_access_token!(
    connectors::Aci,
    connectors::Authipay,
    connectors::Adyenplatform,
    connectors::Adyen,
