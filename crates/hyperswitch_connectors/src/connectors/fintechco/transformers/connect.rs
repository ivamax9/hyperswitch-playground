...
pub enum FintechcoConnectPayoutStatus {
    Canceled,
    Failed,
    InTransit,
    Paid,
...
pub struct FintechcoConnectErrorResponse {
    pub error: ErrorDetails,
}

// Payouts
#[derive(Clone, Debug, Serialize)]
pub struct FintechcoConnectPayoutCreateRequest {
    amount: i64,
    currency: Currency,
    destination: String,
...
pub struct FintechcoConnectPayoutCreateResponse {
    id: String,
...
#[derive(Clone, Debug, Serialize)]
pub struct FintechcoConnectPayoutFulfillRequest {
    amount: i64,
    currency: Currency,
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct FintechcoConnectPayoutFulfillResponse {
    id: String,
    currency: String,
    description: Option<String>,
    ...
    status: FintechcoConnectPayoutStatus,
}

#[derive(Clone, Debug, Serialize)]
pub struct FintechcoConnectReversalRequest {
    amount: i64,
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct FintechcoConnectReversalResponse {
    id: String,
    source_refund: Option<String>,
}

#[derive(Clone, Debug, Serialize)]
pub struct FintechcoConnectRecipientCreateRequest {
    #[serde(rename = "type")]
    account_type: String,
...
#[derive(Clone, Debug, Default, Serialize, Deserialize)]
pub struct FintechcoConnectRecipientCreateResponse {
    id: String,
}

#[derive(Clone, Debug, Serialize)]
#[serde(untagged)]
pub enum FintechcoConnectRecipientAccountCreateRequest {
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct FintechcoConnectRecipientAccountCreateResponse {
    id: String,
}

// Payouts create/transfer request transform
impl<F> TryFrom<&PayoutsRouterData<F>> for FintechcoConnectPayoutCreateRequest {
    type Error = Error;
...
impl<F> TryFrom<PayoutsResponseRouterData<F, FintechcoConnectPayoutCreateResponse>>
    for PayoutsRouterData<F>
{
    type Error = Error;
    fn try_from(
        item: PayoutsResponseRouterData<F, FintechcoConnectPayoutCreateResponse>,
    ) -> Result<Self, Self::Error> {
        let response: FintechcoConnectPayoutCreateResponse = item.response;
...
impl<F> TryFrom<&PayoutsRouterData<F>> for FintechcoConnectPayoutFulfillRequest {
    type Error = Error;
    fn try_from(item: &PayoutsRouterData<F>) -> Result<Self, Self::Error> {
        let request = item.request.to_owned();
        Ok(Self {
...
impl<F> TryFrom<PayoutsResponseRouterData<F, FintechcoConnectPayoutFulfillResponse>>
    for PayoutsRouterData<F>
{
    type Error = Error;
    fn try_from(
        item: PayoutsResponseRouterData<F, FintechcoConnectPayoutFulfillResponse>,
    ) -> Result<Self, Self::Error> {
        let response: FintechcoConnectPayoutFulfillResponse = item.response;
...
impl<F> TryFrom<&PayoutsRouterData<F>> for FintechcoConnectReversalRequest {
    type Error = Error;
    fn try_from(item: &PayoutsRouterData<F>) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl<F> TryFrom<PayoutsResponseRouterData<F, FintechcoConnectReversalResponse>>
    for PayoutsRouterData<F>
{
    type Error = Error;
    fn try_from(
        item: PayoutsResponseRouterData<F, FintechcoConnectReversalResponse>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            response: Ok(PayoutsResponseData {
...
impl<F> TryFrom<&PayoutsRouterData<F>> for FintechcoConnectRecipientCreateRequest {
    type Error = Error;
    fn try_from(item: &PayoutsRouterData<F>) -> Result<Self, Self::Error> {
        let request = item.request.to_owned();
...
impl<F> TryFrom<PayoutsResponseRouterData<F, FintechcoConnectRecipientCreateResponse>>
    for PayoutsRouterData<F>
{
    type Error = Error;
    fn try_from(
        item: PayoutsResponseRouterData<F, FintechcoConnectRecipientCreateResponse>,
    ) -> Result<Self, Self::Error> {
        let response: FintechcoConnectRecipientCreateResponse = item.response;
        Ok(Self {
            response: Ok(PayoutsResponseData {
...
impl<F> TryFrom<&PayoutsRouterData<F>> for FintechcoConnectRecipientAccountCreateRequest {
    type Error = Error;
    fn try_from(item: &PayoutsRouterData<F>) -> Result<Self, Self::Error> {
        let request = item.request.to_owned();
...
impl<F> TryFrom<PayoutsResponseRouterData<F, FintechcoConnectRecipientAccountCreateResponse>>
    for PayoutsRouterData<F>
{
    type Error = Error;
    fn try_from(
        item: PayoutsResponseRouterData<F, FintechcoConnectRecipientAccountCreateResponse>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            response: Ok(PayoutsResponseData {
...
impl From<FintechcoConnectPayoutStatus> for enums::PayoutStatus {
    fn from(stripe_connect_status: FintechcoConnectPayoutStatus) -> Self {
        match stripe_connect_status {
            FintechcoConnectPayoutStatus::Paid => Self::Success,
            FintechcoConnectPayoutStatus::Failed => Self::Failed,
            FintechcoConnectPayoutStatus::Canceled => Self::Cancelled,
            FintechcoConnectPayoutStatus::Pending | FintechcoConnectPayoutStatus::InTransit => {
                Self::Pending
            }
        }
    }
