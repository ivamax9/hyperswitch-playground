...
pub struct FintechcoAuthType {
    pub(super) api_key: Secret<String>,
}

impl TryFrom<&ConnectorAuthType> for FintechcoAuthType {
...
pub enum FintechcoCaptureMethod {
    Manual,
    #[default]
    Automatic,
}

impl From<Option<enums::CaptureMethod>> for FintechcoCaptureMethod {
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoMandateRequest {
    #[serde(flatten)]
    mandate_type: FintechcoMandateType,
}
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoBrowserInformation {
...
pub struct PaymentIntentRequest {
    ...
    #[serde(flatten)]
    pub setup_mandate_details: Option<FintechcoMandateRequest>,
    pub description: Option<String>,
    #[serde(flatten)]
    pub shipping: Option<FintechcoShippingAddress>,
    #[serde(flatten)]
    pub billing: FintechcoBillingAddress,
    #[serde(flatten)]
    pub payment_data: Option<FintechcoPaymentMethodData>,
    pub capture_method: FintechcoCaptureMethod,
    #[serde(flatten)]
    pub payment_method_options: Option<FintechcoPaymentMethodOptions>, // For mandate txns using network_txns_id, needs to be validated
    pub setup_future_usage: Option<enums::FutureUsage>,
    pub off_session: Option<bool>,
    #[serde(rename = "payment_method_types[0]")]
    pub payment_method_types: Option<FintechcoPaymentMethodType>,
    #[serde(rename = "expand[0]")]
    pub expand: Option<ExpandableObjects>,
    #[serde(flatten)]
    pub browser_info: Option<FintechcoBrowserInformation>,
    #[serde(flatten)]
...
pub struct SetupIntentRequest {
    ...
    #[serde(flatten)]
    pub payment_data: FintechcoPaymentMethodData,
    pub payment_method_options: Option<FintechcoPaymentMethodOptions>, // For mandate txns using network_txns_id, needs to be validated
    #[serde(flatten)]
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoCardData {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
    ...
    pub payment_method_data_card_preferred_network: Option<FintechcoCardNetwork>,
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "payment_method_options[card][request_incremental_authorization]")]
    pub request_incremental_authorization: Option<FintechcoRequestIncrementalAuthorization>,
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "payment_method_options[card][request_extended_authorization]")]
    request_extended_authorization: Option<FintechcoRequestExtendedAuthorization>,
    #[serde(rename = "payment_method_options[card][request_overcapture]")]
    pub request_overcapture: Option<FintechcoRequestOvercaptureBool>,
}

#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum FintechcoRequestIncrementalAuthorization {
    IfAvailable,
    Never,
}
...
#[serde(rename_all = "snake_case")]
pub enum FintechcoRequestExtendedAuthorization {
    IfAvailable,
}

#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum FintechcoRequestOvercaptureBool {
    IfAvailable,
}

#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoPayLaterData {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
}
...
pub struct TokenRequest {
    #[serde(flatten)]
    pub token_data: FintechcoPaymentMethodData,
}

#[derive(Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoTokenResponse {
...
#[derive(Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoCustomerResponse {
    pub id: String,
    pub description: Option<String>,
    pub email: Option<Email>,
    pub phone: Option<Secret<String>>,
...
pub struct ChargesResponse {
    ...
    pub currency: String,
    pub status: FintechcoPaymentStatus,
    pub source: FintechcoSourceResponse,
...
#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(untagged)]
pub enum FintechcoBankName {
    Eps {
        #[serde(rename = "payment_method_data[eps][bank]")]
        bank_name: Option<FintechcoBankNames>,
    },
    Ideal {
        #[serde(rename = "payment_method_data[ideal][bank]")]
        ideal_bank_name: Option<FintechcoBankNames>,
    },
    Przelewy24 {
...
#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(untagged)]
pub enum FintechcoBankRedirectData {
    FintechcoGiropay(Box<FintechcoGiropay>),
    FintechcoIdeal(Box<FintechcoIdeal>),
    FintechcoBancontactCard(Box<FintechcoBancontactCard>),
    FintechcoPrezelewy24(Box<FintechcoPrezelewy24>),
    FintechcoEps(Box<FintechcoEps>),
    FintechcoBlik(Box<FintechcoBlik>),
    FintechcoOnlineBankingFpx(Box<FintechcoOnlineBankingFpx>),
}

#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoGiropay {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
}

#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoIdeal {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
    #[serde(rename = "payment_method_data[ideal][bank]")]
    ideal_bank_name: Option<FintechcoBankNames>,
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoBancontactCard {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
}

#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoPrezelewy24 {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
    #[serde(rename = "payment_method_data[p24][bank]")]
    bank_name: Option<FintechcoBankNames>,
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoOnlineBankingFpx {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoPaymentMethodType,
}
...
pub struct AchTransferData {
    ...
    pub bank_transfer_type: FintechcoCreditTransferTypes,
    #[serde(rename = "payment_method_types[0]")]
    pub payment_method_type: FintechcoPaymentMethodType,
...
pub struct MultibancoTransferData {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_data_type: FintechcoCreditTransferTypes,
    #[serde(rename = "payment_method_types[0]")]
    pub payment_method_type: FintechcoCreditTransferTypes,
...
#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(untagged)]
pub enum FintechcoCreditTransferSourceRequest {
...
pub struct AchCreditTransferSourceRequest {
    #[serde(rename = "type")]
    pub transfer_type: FintechcoCreditTransferTypes,
    #[serde(flatten)]
...
#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(untagged)]
pub enum FintechcoPaymentMethodData {
    CardToken(FintechcoCardToken),
    Card(FintechcoCardData),
    PayLater(FintechcoPayLaterData),
    Wallet(FintechcoWallet),
    BankRedirect(FintechcoBankRedirectData),
    BankDebit(FintechcoBankDebitData),
    BankTransfer(FintechcoBankTransferData),
}

#[derive(Debug, Clone, Default, Eq, PartialEq, Serialize)]
pub struct FintechcoBillingAddressCardToken {
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoCardToken {
    #[serde(rename = "type")]
    pub payment_method_type: Option<FintechcoPaymentMethodType>,
    ...
    #[serde(flatten)]
    pub billing: FintechcoBillingAddressCardToken,
}
...
#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoBankDebitData {
    #[serde(flatten)]
...
#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(untagged)]
pub enum FintechcoBankTransferData {
...
#[derive(Debug, Eq, PartialEq, Serialize)]
#[serde(untagged)]
pub enum FintechcoWallet {
    ApplepayToken(FintechcoApplePay),
    ...
    ApplePayPredecryptToken(Box<FintechcoApplePayPredecrypt>),
}

#[derive(Debug, Eq, PartialEq, Serialize)]
pub struct FintechcoApplePayPredecrypt {
    #[serde(rename = "card[number]")]
...
pub struct GooglePayToken {
    #[serde(rename = "payment_method_data[type]")]
    pub payment_type: FintechcoPaymentMethodType,
...
pub struct ApplepayPayment {
    ...
    pub token: Secret<String>,
    #[serde(rename = "payment_method_data[type]")]
    pub payment_method_types: FintechcoPaymentMethodType,
}
...
#[serde(rename_all = "snake_case")]
pub enum FintechcoPaymentMethodType {
    Affirm,
    AfterpayClearpay,
    Alipay,
...
#[serde(rename_all = "snake_case")]
#[allow(dead_code)]
pub enum FintechcoCreditTransferTypes {
...
impl TryFrom<enums::PaymentMethodType> for FintechcoPaymentMethodType {
    type Error = error_stack::Report<ConnectorError>;
...
impl TryFrom<&enums::BankNames> for FintechcoBankNames {
...
fn validate_shipping_address_against_payment_method(
    shipping_address: &Option<FintechcoShippingAddress>,
    payment_method: Option<&FintechcoPaymentMethodType>,
) -> Result<(), error_stack::Report<ConnectorError>> {
    match payment_method {
        Some(FintechcoPaymentMethodType::AfterpayClearpay) => match shipping_address {
            Some(address) => {
...
impl TryFrom<&PayLaterData> for FintechcoPaymentMethodType {
    type Error = ConnectorError;
...
impl TryFrom<&BankRedirectData> for FintechcoPaymentMethodType {
    type Error = ConnectorError;
...
) -> Result<Option<FintechcoPaymentMethodType>, ConnectorError> {
    match wallet_data {
        WalletData::AliPayRedirect(_) => Ok(Some(FintechcoPaymentMethodType::Alipay)),
        WalletData::ApplePay(_) => Ok(None),
        WalletData::GooglePay(_) => Ok(Some(FintechcoPaymentMethodType::Card)),
        WalletData::WeChatPayQr(_) => Ok(Some(FintechcoPaymentMethodType::Wechatpay)),
        WalletData::CashappQr(_) => Ok(Some(FintechcoPaymentMethodType::Cashapp)),
        WalletData::AmazonPayRedirect(_) => Ok(Some(FintechcoPaymentMethodType::AmazonPay)),
        WalletData::RevolutPay(_) => Ok(Some(FintechcoPaymentMethodType::RevolutPay)),
...
impl TryFrom<&payment_method_data::BankDebitData> for FintechcoPaymentMethodType {
    type Error = ConnectorError;
...
) -> (Option<FintechcoPaymentMethodType>, Option<BankDebitData>) {
    match bank_debit_data {
        payment_method_data::BankDebitData::AchBankDebit {
            ...
            (Some(FintechcoPaymentMethodType::Ach), Some(ach_data))
        }
        payment_method_data::BankDebitData::SepaBankDebit { iban, .. } => {
            let sepa_data: BankDebitData = BankDebitData::Sepa {
                iban: iban.to_owned(),
            };
            (Some(FintechcoPaymentMethodType::Sepa), Some(sepa_data))
        }
        payment_method_data::BankDebitData::BecsBankDebit {
            ...
            (Some(FintechcoPaymentMethodType::Becs), Some(becs_data))
        }
        payment_method_data::BankDebitData::BacsBankDebit {
            ...
            (Some(FintechcoPaymentMethodType::Bacs), Some(bacs_data))
        }
        _ => (None, None),
    }
}
...
pub struct PaymentRequestDetails {
    ...
    pub billing_address: FintechcoBillingAddress,
...
fn create_stripe_payment_method(
    ...
    (
        FintechcoPaymentMethodData,
        Option<FintechcoPaymentMethodType>,
        FintechcoBillingAddress,
    ),
...
> {
    match payment_method_data {
        PaymentMethodData::Card(card_details) => {
            ...
            Ok((
                FintechcoPaymentMethodData::try_from((
                    card_details,
                ...
                Some(FintechcoPaymentMethodType::Card),
                payment_request_details.billing_address,
            ))
        }
        PaymentMethodData::PayLater(pay_later_data) => {
            let stripe_pm_type = FintechcoPaymentMethodType::try_from(pay_later_data)?;

            Ok((
                FintechcoPaymentMethodData::PayLater(FintechcoPayLaterData {
        ...
        PaymentMethodData::BankRedirect(bank_redirect_data) => {
            ...
            let pm_type = FintechcoPaymentMethodType::try_from(bank_redirect_data)?;
            let bank_redirect_data = FintechcoPaymentMethodData::try_from(bank_redirect_data)?;
        ...
        PaymentMethodData::Wallet(wallet_data) => {
            ...
            let wallet_specific_data = FintechcoPaymentMethodData::try_from((
                wallet_data,
            ...
            Ok((
                ...
                pm_type,
                FintechcoBillingAddress::default(),
            ))
        }
        PaymentMethodData::BankDebit(bank_debit_data) => {
            let (pm_type, bank_debit_data) = get_bank_debit_data(bank_debit_data);

            let pm_data = FintechcoPaymentMethodData::BankDebit(FintechcoBankDebitData {
        ...
        PaymentMethodData::BankTransfer(bank_transfer_data) => match bank_transfer_data.deref() {
            payment_method_data::BankTransferData::AchBankTransfer {} => Ok((
                FintechcoPaymentMethodData::BankTransfer(FintechcoBankTransferData::AchBankTransfer(
                    Box::new(AchTransferData {
                        payment_method_data_type: FintechcoPaymentMethodType::CustomerBalance,
                        bank_transfer_type: FintechcoCreditTransferTypes::AchCreditTransfer,
                        payment_method_type: FintechcoPaymentMethodType::CustomerBalance,
            ...
            payment_method_data::BankTransferData::MultibancoBankTransfer {} => Ok((
                FintechcoPaymentMethodData::BankTransfer(
                    FintechcoBankTransferData::MultibancoBankTransfers(Box::new(
                        MultibancoTransferData {
                            payment_method_data_type: FintechcoCreditTransferTypes::Multibanco,
                            payment_method_type: FintechcoCreditTransferTypes::Multibanco,
            ...
            payment_method_data::BankTransferData::SepaBankTransfer {} => Ok((
                FintechcoPaymentMethodData::BankTransfer(FintechcoBankTransferData::SepaBankTransfer(
                ...
                Some(FintechcoPaymentMethodType::CustomerBalance),
                payment_request_details.billing_address,
            )),
            payment_method_data::BankTransferData::BacsBankTransfer {} => Ok((
                FintechcoPaymentMethodData::BankTransfer(FintechcoBankTransferData::BacsBankTransfers(
...
fn get_stripe_card_network(card_network: common_enums::CardNetwork) -> Option<FintechcoCardNetwork> {
    match card_network {
        common_enums::CardNetwork::Visa => Some(FintechcoCardNetwork::Visa),
        common_enums::CardNetwork::Mastercard => Some(FintechcoCardNetwork::Mastercard),
        common_enums::CardNetwork::CartesBancaires => Some(FintechcoCardNetwork::CartesBancaires),
...
impl
    TryFrom<(
        ...
        bool,
        Option<primitive_wrappers::RequestExtendedAuthorizationBool>,
        Option<FintechcoRequestOvercaptureBool>,
    )> for FintechcoPaymentMethodData
{
    type Error = ConnectorError;
    fn try_from(
        (
        ...
        Ok(Self::Card(FintechcoCardData {
            payment_method_data_type: FintechcoPaymentMethodType::Card,
            ...
            request_incremental_authorization: if request_incremental_authorization {
                Some(FintechcoRequestIncrementalAuthorization::IfAvailable)
            } else {
                None
            },
            request_extended_authorization: if request_extended_authorization
                ...
                .unwrap_or(false)
            {
                Some(FintechcoRequestExtendedAuthorization::IfAvailable)
            } else {
                None
            },
            request_overcapture,
...
impl TryFrom<(&WalletData, Option<PaymentMethodToken>)> for FintechcoPaymentMethodData {
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(
        ...
        match wallet_data {
            WalletData::ApplePay(applepay_data) => {
                let mut apple_pay_decrypt_data =
                        ...
                        payment_method_token
                    {
                        ...
                        Some(Self::Wallet(FintechcoWallet::ApplePayPredecryptToken(
                            Box::new(FintechcoApplePayPredecrypt {
                        ...
                        payment_method_token
                    {
                        Some(Self::Wallet(FintechcoWallet::ApplepayPayment(
                            ApplepayPayment {
                                token: applepay_token,
                                payment_method_types: FintechcoPaymentMethodType::Card,
                            },
                        )))
                    } else {
                        None
                ...
                if apple_pay_decrypt_data.is_none() {
                    apple_pay_decrypt_data =
                        Some(Self::Wallet(FintechcoWallet::ApplepayToken(FintechcoApplePay {
            ...
            WalletData::WeChatPayQr(_) => Ok(Self::Wallet(FintechcoWallet::WechatpayPayment(
                WechatpayPayment {
                    client: WechatClient::Web,
                    payment_method_data_type: FintechcoPaymentMethodType::Wechatpay,
                },
            ))),
            WalletData::AliPayRedirect(_) => {
                Ok(Self::Wallet(FintechcoWallet::AlipayPayment(AlipayPayment {
                    payment_method_data_type: FintechcoPaymentMethodType::Alipay,
                })))
            }
            WalletData::CashappQr(_) => Ok(Self::Wallet(FintechcoWallet::Cashapp(CashappPayment {
                payment_method_data_type: FintechcoPaymentMethodType::Cashapp,
            }))),
            WalletData::AmazonPayRedirect(_) => Ok(Self::Wallet(FintechcoWallet::AmazonpayPayment(
                AmazonpayPayment {
                    payment_method_types: FintechcoPaymentMethodType::AmazonPay,
                },
            ))),
            WalletData::RevolutPay(_) => {
                Ok(Self::Wallet(FintechcoWallet::RevolutPay(RevolutpayPayment {
                    payment_method_types: FintechcoPaymentMethodType::RevolutPay,
                })))
            }
...
impl TryFrom<&BankRedirectData> for FintechcoPaymentMethodData {
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(bank_redirect_data: &BankRedirectData) -> Result<Self, Self::Error> {
        let payment_method_data_type = FintechcoPaymentMethodType::try_from(bank_redirect_data)?;
        match bank_redirect_data {
            BankRedirectData::BancontactCard { .. } => Ok(Self::BankRedirect(
                FintechcoBankRedirectData::FintechcoBancontactCard(Box::new(FintechcoBancontactCard {
                    payment_method_data_type,
                })),
            )),
            BankRedirectData::Blik { blik_code } => Ok(Self::BankRedirect(
                FintechcoBankRedirectData::FintechcoBlik(Box::new(FintechcoBlik {
                    payment_method_data_type,
            ...
            BankRedirectData::Eps { bank_name, .. } => Ok(Self::BankRedirect(
                FintechcoBankRedirectData::FintechcoEps(Box::new(FintechcoEps {
                    payment_method_data_type,
                    bank_name: bank_name
                        .map(|bank_name| FintechcoBankNames::try_from(&bank_name))
                        .transpose()?,
                })),
            )),
            BankRedirectData::Giropay { .. } => Ok(Self::BankRedirect(
                FintechcoBankRedirectData::FintechcoGiropay(Box::new(FintechcoGiropay {
                    payment_method_data_type,
                })),
            )),
            BankRedirectData::Ideal { bank_name, .. } => {
                let bank_name = bank_name
                    .map(|bank_name| FintechcoBankNames::try_from(&bank_name))
                    .transpose()?;
                Ok(Self::BankRedirect(FintechcoBankRedirectData::FintechcoIdeal(
                    Box::new(FintechcoIdeal {
                        payment_method_data_type,
            ...
            BankRedirectData::Przelewy24 { bank_name, .. } => {
                ...
                Ok(Self::BankRedirect(
                    FintechcoBankRedirectData::FintechcoPrezelewy24(Box::new(FintechcoPrezelewy24 {
                        payment_method_data_type,
                        bank_name,
                    })),
                ))
...
impl TryFrom<&GooglePayWalletData> for FintechcoPaymentMethodData {
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(gpay_data: &GooglePayWalletData) -> Result<Self, Self::Error> {
        Ok(Self::Wallet(FintechcoWallet::GooglepayToken(GooglePayToken {
            token: Secret::new(
                gpay_data
                    .tokenization_data
                    ...
                    .as_bytes()
                    .parse_struct::<FintechcoGpayToken>("FintechcoGpayToken")
                    .change_context(ConnectorError::InvalidWalletToken {
                        wallet_name: "Google Pay".to_string(),
                    })?
                    .id,
            ),
            payment_type: FintechcoPaymentMethodType::Card,
        })))
    }
}
...
impl TryFrom<(&PaymentsAuthorizeRouterData, MinorUnit)> for PaymentIntentRequest {
    ...
    fn try_from(data: (&PaymentsAuthorizeRouterData, MinorUnit)) -> Result<Self, Self::Error> {
            ...
            mandate_metadata.as_ref().and_then(|s| s.as_ref())
        {
            ...
            let parsed: Result<FintechcoSplitPaymentRequest, _> = serde_json::from_value(json_value);
        ...
        let (
                ...
                .and_then(|mandate_ids| mandate_ids.mandate_reference_id)
            {
                ...
                Some(payments::MandateReferenceId::NetworkMandateId(network_transaction_id)) => {
                    payment_method_options = Some(FintechcoPaymentMethodOptions::Card {
                    ...
                    let payment_data = match item.request.payment_method_data {
                        ...
                        ) => FintechcoPaymentMethodData::Card(FintechcoCardData {
                            payment_method_data_type: FintechcoPaymentMethodType::Card,
        ...
        if payment_method_token.is_none() {
            payment_data = match item.request.payment_method_data {
                PaymentMethodData::Wallet(WalletData::ApplePay(_)) => {
                    ...
                    Some(FintechcoPaymentMethodData::Wallet(
                        FintechcoWallet::ApplepayPayment(ApplepayPayment {
                        ...
                        Ok::<_, error_stack::Report<ConnectorError>>(
                            match customer_acceptance.acceptance_type {
                                AcceptanceType::Online => {
                                    ...
                                    FintechcoMandateRequest {
                                        mandate_type: FintechcoMandateType::Online {
                                ...
                                AcceptanceType::Offline => FintechcoMandateRequest {
                                    mandate_type: FintechcoMandateType::Offline,
                                },
                            },
                        )
                    })
            ...
            .or_else(|| {
                ...
                if payment_method.is_some() {
                    ...
                    match &payment_method_types {
                        ...
                        Some(
                            FintechcoPaymentMethodType::Ach
                            | FintechcoPaymentMethodType::Sepa
                            | FintechcoPaymentMethodType::Becs
                            | FintechcoPaymentMethodType::Bacs,
                        ) => Some(FintechcoMandateRequest {
                            mandate_type: FintechcoMandateType::Offline,
                        }),
                        _ => None,
                    }
        ...
        let browser_info = if payment_data.is_some() && payment_method_token.is_none() {
            item.request
                .browser_info
                .clone()
                .map(FintechcoBrowserInformation::from)
        } else {
            None
        };
        ...
        Ok(Self {
            ...
            capture_method: FintechcoCaptureMethod::from(item.request.capture_method),
            payment_data,
...
fn get_stripe_overcapture_request(
    ...
    match enable_overcapture.deref() {
        true => Some(FintechcoRequestOvercaptureBool::IfAvailable),
        false => None,
    }
}
...
) -> Result<Option<FintechcoPaymentMethodType>, error_stack::Report<ConnectorError>> {
    if item.payment_method == api_enums::PaymentMethod::Card {
        Ok(Some(FintechcoPaymentMethodType::Card)) //stripe takes ["Card"] as default
    } else {
            ...
            Some(recurring_payment_method_data) => {
                match recurring_payment_method_data.payment_method_type {
                    Some(payment_method_type) => {
                        FintechcoPaymentMethodType::try_from(payment_method_type)
                    }
                    None => Err(ConnectorError::MissingRequiredField {
        ...
        match stripe_payment_method_type {
            ...
            FintechcoPaymentMethodType::Ideal
            | FintechcoPaymentMethodType::Bancontact
            | FintechcoPaymentMethodType::Sofort => Ok(Some(FintechcoPaymentMethodType::Sepa)),
            _ => Ok(Some(stripe_payment_method_type)),
        }
    }
}

impl From<BrowserInformation> for FintechcoBrowserInformation {
...
impl TryFrom<&SetupMandateRouterData> for SetupIntentRequest {
    ...
    fn try_from(item: &SetupMandateRouterData) -> Result<Self, Self::Error> {
        ...
        let pm_type = FintechcoPaymentMethodType::Card;
        let payment_data = FintechcoPaymentMethodData::try_from((item, item.auth_type, pm_type))?;
...
impl TryFrom<&TokenizationRouterData> for TokenRequest {
    ...
    fn try_from(item: &TokenizationRouterData) -> Result<Self, Self::Error> {
        let billing_address = FintechcoBillingAddressCardToken {
            name: item.get_optional_billing_full_name(),
            email: item.get_optional_billing_email(),
            phone: item.get_optional_billing_phone_number(),
            address_line1: item.get_optional_billing_line1(),
        ...
        let request_payment_data = match &item.request.payment_method_data {
            PaymentMethodData::Card(card_details) => {
                FintechcoPaymentMethodData::CardToken(FintechcoCardToken {
                    payment_method_type: Some(FintechcoPaymentMethodType::Card),
            ...
            _ => {
                create_stripe_payment_method(
                    ...
                    PaymentRequestDetails {
                        ...
                        billing_address: FintechcoBillingAddress::default(),
...
pub struct FintechcoSplitPaymentRequest {
...
pub fn get_stripe_compatible_connect_account_header(
    ...
    let cit_metadata = request
        ...
        .and_then(|secret_value| {
            let json_value = secret_value.clone().expose();
            match serde_json::from_value::<FintechcoSplitPaymentRequest>(json_value.clone()) {
                Ok(val) => Some(val),
                Err(err) => {
...
pub struct FintechcoIncrementalAuthRequest {
    pub amount: MinorUnit,
}

#[derive(Clone, Default, Debug, Eq, PartialEq, Deserialize, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum FintechcoPaymentStatus {
    Succeeded,
    Failed,
    #[default]
    Processing,
...
impl From<FintechcoPaymentStatus> for AttemptStatus {
    fn from(item: FintechcoPaymentStatus) -> Self {
        match item {
            FintechcoPaymentStatus::Succeeded => Self::Charged,
            FintechcoPaymentStatus::Failed => Self::Failure,
            FintechcoPaymentStatus::Processing => Self::Authorizing,
            FintechcoPaymentStatus::RequiresCustomerAction => Self::AuthenticationPending,
            // Make the payment attempt status as failed
            FintechcoPaymentStatus::RequiresPaymentMethod => Self::Failure,
            FintechcoPaymentStatus::RequiresConfirmation => Self::ConfirmationAwaited,
            FintechcoPaymentStatus::Canceled => Self::Voided,
            FintechcoPaymentStatus::RequiresCapture => Self::Authorized,
            FintechcoPaymentStatus::Chargeable => Self::Authorizing,
            FintechcoPaymentStatus::Consumed => Self::Authorizing,
            FintechcoPaymentStatus::Pending => Self::Pending,
        }
    }
}
...
pub struct PaymentIntentResponse {
    ...
    pub statement_descriptor: Option<String>,
    pub statement_descriptor_suffix: Option<String>,
    pub metadata: FintechcoMetadata,
    pub next_action: Option<FintechcoNextActionResponse>,
    pub payment_method_options: Option<FintechcoPaymentMethodOptions>,
    pub last_payment_error: Option<ErrorDetails>,
    pub latest_attempt: Option<LatestAttempt>, //need a merchant to test this
    pub latest_charge: Option<FintechcoChargeEnum>,
}

#[derive(Clone, Debug, Default, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoSourceResponse {
    pub id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[serde(untagged)]
pub enum FintechcoChargeEnum {
    ChargeId(String),
    ChargeObject(Box<FintechcoCharge>),
}

impl FintechcoChargeEnum {
        ...
        match self {
            Self::ChargeObject(charge_object) => charge_object
                ...
                .and_then(|payment_method_details| match payment_method_details {
                    FintechcoPaymentMethodDetailsResponse::Card { card } => card
                        .overcapture
                        .as_ref()
                        .and_then(|overcapture| match overcapture.status {
                            Some(FintechcoOvercaptureStatus::Available) => {
                                Some(primitive_wrappers::OvercaptureEnabledBool::new(true))
                            }
                            Some(FintechcoOvercaptureStatus::Unavailable) => {
...
pub struct FintechcoCharge {
    pub id: String,
    pub payment_method_details: Option<FintechcoPaymentMethodDetailsResponse>,
}

#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
pub struct FintechcoBankRedirectDetails {
    #[serde(rename = "generated_sepa_debit")]
    attached_payment_method: Option<Secret<String>>,
}

#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
pub struct FintechcoCashappDetails {
...
#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
pub struct FintechcoAdditionalCardDetails {
    checks: Option<Value>,
    three_d_secure: Option<Value>,
    network_transaction_id: Option<String>,
    extended_authorization: Option<FintechcoExtendedAuthorizationResponse>,
    #[serde(default, with = "common_utils::custom_serde::timestamp::option")]
    capture_before: Option<PrimitiveDateTime>,
    overcapture: Option<FintechcoOvercaptureResponse>,
}

#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
pub struct FintechcoExtendedAuthorizationResponse {
    status: Option<FintechcoExtendedAuthorizationStatus>,
}

#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
#[serde(rename_all = "lowercase")]
pub enum FintechcoExtendedAuthorizationStatus {
    Disabled,
    Enabled,
}

#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
pub struct FintechcoOvercaptureResponse {
    status: Option<FintechcoOvercaptureStatus>,
    #[serde(default, deserialize_with = "deserialize_zero_minor_amount_as_none")]
    // stripe gives amount_captured as 0 for payment intents instead of null
...
#[derive(Deserialize, Clone, Debug, PartialEq, Eq, Serialize)]
#[serde(rename_all = "snake_case")]
pub enum FintechcoOvercaptureStatus {
    Available,
    Unavailable,
}
...
pub enum FintechcoPaymentMethodDetailsResponse {
    //only ideal and bancontact is supported by stripe for recurring payment in bank redirect
    Ideal {
        ideal: FintechcoBankRedirectDetails,
    },
    Bancontact {
        bancontact: FintechcoBankRedirectDetails,
    },
    ...
    Przelewy24,
    Card {
        card: FintechcoAdditionalCardDetails,
    },
    Cashapp {
        cashapp: FintechcoCashappDetails,
    },
    Klarna,
    Affirm,
    AfterpayClearpay,
...
pub struct AdditionalPaymentMethodDetails {
    ...
    pub extended_authorization: Option<FintechcoExtendedAuthorizationResponse>,
    ...
    match item
        ...
        .map(|extended_authorization| {
            matches!(
                ...
                Some(FintechcoExtendedAuthorizationStatus::Enabled)
            )
        }) {
...
impl FintechcoPaymentMethodDetailsResponse {
...
pub struct SetupIntentResponse {
    pub id: String,
    pub object: String,
    pub status: FintechcoPaymentStatus, // Change to SetupStatus
...
fn extract_payment_method_connector_response_from_latest_charge(
    stripe_charge_enum: &FintechcoChargeEnum,
    created_at: Option<PrimitiveDateTime>,
) -> Option<ConnectorResponseData> {
    let is_overcapture_enabled = stripe_charge_enum.get_overcapture_status();
    let additional_payment_method_details =
        if let FintechcoChargeEnum::ChargeObject(charge_object) = stripe_charge_enum {
            charge_object
                .payment_method_details
                .as_ref()
                .and_then(FintechcoPaymentMethodDetailsResponse::get_additional_payment_method_data)
        } else {
            None
        };
    ...
    T: SplitPaymentData + GetRequestIncrementalAuthorization,
{
    ...
    fn try_from(
        ...
        let network_txn_id = match item.response.latest_charge.as_ref() {
            Some(FintechcoChargeEnum::ChargeObject(charge_object)) => charge_object
                .payment_method_details
                .as_ref()
                .and_then(|payment_method_details| match payment_method_details {
                    FintechcoPaymentMethodDetailsResponse::Card { card } => {
            ...
            *get_stripe_payments_response_data(
            ...
            let charges = item
                ...
                .map(|charge| match charge {
                    FintechcoChargeEnum::ChargeId(charges) => charges.clone(),
                    FintechcoChargeEnum::ChargeObject(charge) => charge.id.clone(),
                })
        ...
        let minor_amount_capturable = item
            ...
            .latest_charge
            .as_ref()
            .and_then(FintechcoChargeEnum::get_maximum_capturable_amount);
...
impl From<FintechcoPaymentStatus> for common_enums::AuthorizationStatus {
    fn from(item: FintechcoPaymentStatus) -> Self {
        match item {
            FintechcoPaymentStatus::Succeeded
            | FintechcoPaymentStatus::RequiresCapture
            | FintechcoPaymentStatus::Chargeable
            | FintechcoPaymentStatus::RequiresCustomerAction
            | FintechcoPaymentStatus::RequiresConfirmation
            | FintechcoPaymentStatus::Consumed => Self::Success,
            FintechcoPaymentStatus::Processing | FintechcoPaymentStatus::Pending => Self::Processing,
            FintechcoPaymentStatus::Failed
            | FintechcoPaymentStatus::Canceled
            | FintechcoPaymentStatus::RequiresPaymentMethod => Self::Failure,
        }
    }
}
...
pub fn get_connector_metadata(
    next_action: Option<&FintechcoNextActionResponse>,
    amount: MinorUnit,
    ...
    let next_action_response = next_action
        .and_then(|next_action_response| match next_action_response {
            FintechcoNextActionResponse::DisplayBankTransferInstructions(response) => {
                match response.financial_addresses.clone() {
                    FinancialInformation::FintechcoFinancialInformation(financial_addresses) => {
            ...
            FintechcoNextActionResponse::WechatPayDisplayQrCode(response) => {
            ...
            FintechcoNextActionResponse::CashappHandleRedirectOrDisplayQrCode(response) => {
            ...
            FintechcoNextActionResponse::MultibancoDisplayDetails(response) => {
...
pub fn get_payment_method_id(
    latest_charge: Option<FintechcoChargeEnum>,
    payment_method_id_from_intent_root: Secret<String>,
) -> String {
    match latest_charge {
        Some(FintechcoChargeEnum::ChargeObject(charge)) => match charge.payment_method_details {
            Some(FintechcoPaymentMethodDetailsResponse::Bancontact { bancontact }) => bancontact
            ...
            Some(FintechcoPaymentMethodDetailsResponse::Ideal { ideal }) => ideal
                .attached_payment_method
                .map(|attached_payment_method| attached_payment_method.expose())
                .unwrap_or(payment_method_id_from_intent_root.expose()),
            Some(FintechcoPaymentMethodDetailsResponse::Blik)
            | Some(FintechcoPaymentMethodDetailsResponse::Eps)
            | Some(FintechcoPaymentMethodDetailsResponse::Fpx)
            | Some(FintechcoPaymentMethodDetailsResponse::Giropay)
            | Some(FintechcoPaymentMethodDetailsResponse::Przelewy24)
            | Some(FintechcoPaymentMethodDetailsResponse::Card { .. })
            | Some(FintechcoPaymentMethodDetailsResponse::Klarna)
            | Some(FintechcoPaymentMethodDetailsResponse::Affirm)
            | Some(FintechcoPaymentMethodDetailsResponse::AfterpayClearpay)
            | Some(FintechcoPaymentMethodDetailsResponse::AmazonPay)
            | Some(FintechcoPaymentMethodDetailsResponse::ApplePay)
            | Some(FintechcoPaymentMethodDetailsResponse::Ach)
            | Some(FintechcoPaymentMethodDetailsResponse::Sepa)
            | Some(FintechcoPaymentMethodDetailsResponse::Becs)
            | Some(FintechcoPaymentMethodDetailsResponse::Bacs)
            | Some(FintechcoPaymentMethodDetailsResponse::Wechatpay)
            | Some(FintechcoPaymentMethodDetailsResponse::Alipay)
            | Some(FintechcoPaymentMethodDetailsResponse::CustomerBalance)
            | Some(FintechcoPaymentMethodDetailsResponse::Cashapp { .. })
            | Some(FintechcoPaymentMethodDetailsResponse::RevolutPay)
            | None => payment_method_id_from_intent_root.expose(),
        },
        Some(FintechcoChargeEnum::ChargeId(_)) | None => payment_method_id_from_intent_root.expose(),
    }
}
    ...
    match latest_attempt {
        Some(LatestAttempt::PaymentIntentAttempt(attempt)) => attempt
            ...
            .and_then(|payment_method_options| match payment_method_options {
                FintechcoPaymentMethodOptions::Card {
...
pub enum FintechcoNextActionResponse {
    CashappHandleRedirectOrDisplayQrCode(FintechcoCashappQrResponse),
    RedirectToUrl(FintechcoRedirectToUrlResponse),
    AlipayHandleRedirect(FintechcoRedirectToUrlResponse),
    VerifyWithMicrodeposits(FintechcoVerifyWithMicroDepositsResponse),
    WechatPayDisplayQrCode(WechatPayRedirectToQr),
    DisplayBankTransferInstructions(FintechcoBankTransferDetails),
    MultibancoDisplayDetails(MultibancoCreditTansferResponse),
    NoNextActionBody,
}

impl FintechcoNextActionResponse {
...
impl<'de> Deserialize<'de> for FintechcoNextActionResponse {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        #[derive(Deserialize)]
        struct Wrapper {
            #[serde(rename = "type")]
            _ignore: String,
            #[serde(flatten, with = "FintechcoNextActionResponse")]
            inner: FintechcoNextActionResponse,
        }
...
impl Serialize for FintechcoNextActionResponse {
...
#[derive(Clone, Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoRedirectToUrlResponse {
    return_url: String,
    url: Url,
}
...
#[derive(Clone, Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoVerifyWithMicroDepositsResponse {
...
pub enum FinancialInformation {
    ...
    FintechcoFinancialInformation(Vec<FintechcoFinancialInformation>),
}

#[derive(Clone, Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoBankTransferDetails {
    pub amount_remaining: MinorUnit,
    pub currency: String,
...
#[derive(Clone, Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoCashappQrResponse {
...
#[derive(Clone, Debug, Eq, PartialEq, Deserialize, Serialize)]
pub struct FintechcoFinancialInformation {
...
pub struct RefundRequest {
    ...
    #[serde(flatten)]
    pub meta_data: FintechcoMetadata,
}
...
#[derive(Debug, Default, Eq, PartialEq, Serialize)]
pub struct FintechcoShippingAddress {
...
#[derive(Debug, Clone, Default, Eq, PartialEq, Serialize)]
pub struct FintechcoBillingAddress {
    #[serde(rename = "payment_method_data[billing_details][email]")]
    pub email: Option<Email>,
...
#[serde(rename_all = "snake_case")]
#[serde(untagged)]
pub enum FintechcoPaymentMethodOptions {
    Card {
        mandate_options: Option<FintechcoMandateOptions>,
...
pub struct FintechcoMandateOptions {
...
impl<F, T> TryFrom<ResponseRouterData<F, FintechcoSourceResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, FintechcoSourceResponse, T, PaymentsResponseData>,
    ) -> Result<Self, Self::Error> {
...
impl<F, T> TryFrom<ResponseRouterData<F, FintechcoTokenResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, FintechcoTokenResponse, T, PaymentsResponseData>,
    ) -> Result<Self, Self::Error> {
...
impl<F, T> TryFrom<ResponseRouterData<F, FintechcoCustomerResponse, T, PaymentsResponseData>>
    for RouterData<F, T, PaymentsResponseData>
{
    type Error = error_stack::Report<ConnectorError>;
    fn try_from(
        item: ResponseRouterData<F, FintechcoCustomerResponse, T, PaymentsResponseData>,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
...
pub struct WebhookEventObjectData {
    ...
    pub status: Option<WebhookEventStatus>,
    pub metadata: Option<FintechcoMetadata>,
    pub last_payment_error: Option<ErrorDetails>,
}
    ...
    )> for FintechcoPaymentMethodData
{
    ...
    fn try_from(
        ...
        match pm_data {
            ...
            PaymentMethodData::PayLater(_) => Ok(Self::PayLater(FintechcoPayLaterData {
            ...
            PaymentMethodData::BankDebit(bank_debit_data) => {
                ...
                Ok(Self::BankDebit(FintechcoBankDebitData {
            ...
            PaymentMethodData::BankTransfer(bank_transfer_data) => match bank_transfer_data.deref()
            {
                payment_method_data::BankTransferData::AchBankTransfer {} => {
                    Ok(Self::BankTransfer(FintechcoBankTransferData::AchBankTransfer(
                        Box::new(AchTransferData {
                            payment_method_data_type: FintechcoPaymentMethodType::CustomerBalance,
                            bank_transfer_type: FintechcoCreditTransferTypes::AchCreditTransfer,
                            payment_method_type: FintechcoPaymentMethodType::CustomerBalance,
                ...
                payment_method_data::BankTransferData::MultibancoBankTransfer {} => Ok(
                    Self::BankTransfer(FintechcoBankTransferData::MultibancoBankTransfers(Box::new(
                        MultibancoTransferData {
                            payment_method_data_type: FintechcoCreditTransferTypes::Multibanco,
                            payment_method_type: FintechcoCreditTransferTypes::Multibanco,
                ...
                payment_method_data::BankTransferData::SepaBankTransfer {} => {
                    Ok(Self::BankTransfer(
                        FintechcoBankTransferData::SepaBankTransfer(Box::new(SepaBankTransferData {
                            payment_method_data_type: FintechcoPaymentMethodType::CustomerBalance,
                            bank_transfer_type: BankTransferType::EuBankTransfer,
                            balance_funding_type: BankTransferType::BankTransfers,
                            payment_method_type: FintechcoPaymentMethodType::CustomerBalance,
                ...
                payment_method_data::BankTransferData::BacsBankTransfer { .. } => {
                    Ok(Self::BankTransfer(
                        FintechcoBankTransferData::BacsBankTransfers(Box::new(BacsBankTransferData {
                            payment_method_data_type: FintechcoPaymentMethodType::CustomerBalance,
                            bank_transfer_type: BankTransferType::GbBankTransfer,
                            balance_funding_type: BankTransferType::BankTransfers,
                            payment_method_type: FintechcoPaymentMethodType::CustomerBalance,
...
#[derive(Debug, Serialize)]
pub struct FintechcoFileRequest {
...
pub fn construct_file_upload_request(
    ...
    let stripe_file_request = FintechcoFileRequest {
...
fn mandatory_parameters_for_sepa_bank_debit_mandates(
    billing_details: &Option<FintechcoBillingAddress>,
    is_customer_initiated_mandate_payment: Option<bool>,
) -> Result<FintechcoBillingAddress, ConnectorError> {
    ...
    match is_customer_initiated_mandate_payment {
        Some(true) => Ok(FintechcoBillingAddress {
        ...
        Some(false) | None => Ok(FintechcoBillingAddress {
            name: billing_name,
            email: billing_email,
            ..FintechcoBillingAddress::default()
        }),
    ...
    T: SplitPaymentData,
{
    ...
    if let Some(SplitPaymentsRequest::StripeSplitPayment(stripe_split_payment)) = charge_request {
        let stripe_charge_response = common_types::payments::FintechcoChargeResponseData {
...
mod test_validate_shipping_address_against_payment_method {
    ...
    use crate::connectors::stripe::transformers::{
        validate_shipping_address_against_payment_method, FintechcoPaymentMethodType,
        FintechcoShippingAddress,
    };
    ...
    fn should_return_ok() {
        ...
        let payment_method = &FintechcoPaymentMethodType::AfterpayClearpay;
