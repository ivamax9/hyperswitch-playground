...
use fintechco::auth_headers;

use self::transformers as fintechco;
#[cfg(feature = "payouts")]
use crate::utils::{PayoutsData as OtherPayoutsData, RouterData as OtherRouterData};
use crate::{
    connectors::fintechco::transformers::get_stripe_compatible_connect_account_header,
...
impl<Flow, Request, Response> ConnectorCommonExt<Flow, Request, Response> for Fintechco
where
...
impl ConnectorCommon for Fintechco {
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        // &self.base_url
        connectors.fintechco.base_url.as_ref()
    }
    ...
    fn get_auth_header(
        ...
        let auth = fintechco::FintechcoAuthType::try_from(auth_type)
    ...
    fn build_error_response(
        ...
        let response: fintechco::FintechcoConnectErrorResponse = res
            .response
...
impl ConnectorValidation for Fintechco {
...
impl api::Payment for Fintechco {}

impl api::PaymentAuthorize for Fintechco {}
impl api::PaymentUpdateMetadata for Fintechco {}
impl api::PaymentSync for Fintechco {}
impl api::PaymentVoid for Fintechco {}
impl api::PaymentCapture for Fintechco {}
impl api::PaymentSession for Fintechco {}
impl api::ConnectorAccessToken for Fintechco {}

impl ConnectorIntegration<AccessTokenAuth, AccessTokenRequestData, AccessToken> for Fintechco {
    // Not Implemented (R)
}

impl ConnectorIntegration<Session, PaymentsSessionData, PaymentsResponseData> for Fintechco {
    // Not Implemented (R)
}

impl api::ConnectorCustomer for Fintechco {}
    ...
    for Fintechco
{
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::CustomerRequest::try_from(req)?;
    ...
    {
        let response: fintechco::FintechcoCustomerResponse = res
            .response
    ...
    fn get_error_response(
        ...
        let response: fintechco::ErrorResponse = res
            .response
...
impl api::PaymentToken for Fintechco {}
    ...
    for Fintechco
{
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::TokenRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    where
        PaymentsResponseData: Clone,
    {
        let response: fintechco::FintechcoTokenResponse = res
            .response
...
impl api::MandateSetup for Fintechco {}

impl ConnectorIntegration<Capture, PaymentsCaptureData, PaymentsResponseData> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::CaptureRequest::try_from(amount)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    where
        ...
        PaymentsResponseData: Clone,
    {
        let response: fintechco::PaymentIntentResponse = res
            .response
...
impl ConnectorIntegration<PSync, PaymentsSyncData, PaymentsResponseData> for Fintechco {
    fn get_headers(
        &self,
        ...
        PaymentsResponseData: Clone,
    {
        ...
        match id.get_connector_transaction_id() {
            Ok(x) if x.starts_with("set") => {
                let response: fintechco::SetupIntentResponse = res
                    .response
            ...
            Ok(_) => {
                let response: fintechco::PaymentIntentSyncResponse = res
                    .response
...
impl ConnectorIntegration<Authorize, PaymentsAuthorizeData, PaymentsResponseData> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::PaymentIntentRequest::try_from((req, amount))?;
...
impl PaymentIncrementalAuthorization for Fintechco {}
    ...
    > for Fintechco
{
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::FintechcoIncrementalAuthRequest { amount }; // Incremental authorization can be done a maximum of 10 times in Stripe
    ...
    for Fintechco
{
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::UpdateMetadataRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
...
impl ConnectorIntegration<Void, PaymentsCancelData, PaymentsResponseData> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::CancelRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
...
impl ConnectorIntegration<SetupMandate, SetupMandateRequestData, PaymentsResponseData> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::SetupIntentRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
...
impl api::Refund for Fintechco {}
impl api::RefundExecute for Fintechco {}
impl api::RefundSync for Fintechco {}

impl ConnectorIntegration<Execute, RefundsData, RefundsResponseData> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let request_body = match req.request.split_refunds.as_ref() {
            Some(SplitRefundsRequest::StripeSplitRefund(_)) => RequestContent::FormUrlEncoded(
                Box::new(fintechco::ChargeRefundRequest::try_from(req)?),
            ),
            _ => RequestContent::FormUrlEncoded(Box::new(fintechco::RefundRequest::try_from((
                req,
                refund_amount,
            ))?)),
        };
    ...
    fn handle_response(
        ...
        let response: fintechco::RefundResponse =
            res.response
...
impl ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Fintechco {
    fn get_headers(
        &self,
...
impl UploadFile for Fintechco {}

#[async_trait::async_trait]
impl FileUpload for Fintechco {
...
impl ConnectorIntegration<Upload, UploadFileRequestData, UploadFileResponse> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_url(
        ...
        Ok(format!(
            "{}{}",
            connectors.fintechco.base_url, "v1/files"
        ))
    }
    ...
    {
        let response: fintechco::FileUploadResponse = res
            .response
...
impl RetrieveFile for Fintechco {}

impl ConnectorIntegration<Retrieve, RetrieveFileRequestData, RetrieveFileResponse> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_url(
        ...
        Ok(format!(
            "{}v1/files/{}/contents",
            connectors.fintechco.base_url, req.request.provider_file_id
        ))
    }
...
impl SubmitEvidence for Fintechco {}

impl ConnectorIntegration<Evidence, SubmitEvidenceRequestData, SubmitEvidenceResponse> for Fintechco {
    fn get_headers(
        &self,
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::Evidence::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fintechco::DisputeObj = res
            .response
...
#[async_trait::async_trait]
impl IncomingWebhook for Fintechco {
    ...
    fn get_webhook_object_reference_id(
        ...
        let details: fintechco::WebhookEvent = request
            .body
        ...
        Ok(match details.event_data.event_object.object {
            fintechco::WebhookEventObjectType::PaymentIntent => {
                match details
                    .event_data
                    .event_object
                    .metadata
            ...
            fintechco::WebhookEventObjectType::Charge => {
                match details
                    .event_data
                    .event_object
                    .metadata
            ...
            fintechco::WebhookEventObjectType::Dispute => {
            ...
            fintechco::WebhookEventObjectType::Source => {
                api_models::webhooks::ObjectReferenceId::PaymentId(
            ...
            fintechco::WebhookEventObjectType::Refund => {
                match details
                    .event_data
                    .event_object
                    .metadata
    ...
    fn get_webhook_event_type(
        ...
        let details: fintechco::WebhookEventTypeBody = request
            .body
            .parse_struct("WebhookEventTypeBody")
            .change_context(ConnectorError::WebhookReferenceIdNotFound)?;

        Ok(match details.event_type {
            fintechco::WebhookEventType::PaymentIntentFailed => {
                IncomingWebhookEvent::PaymentIntentFailure
            }
            fintechco::WebhookEventType::PaymentIntentSucceed => {
                IncomingWebhookEvent::PaymentIntentSuccess
            }
            fintechco::WebhookEventType::PaymentIntentCanceled => {
                IncomingWebhookEvent::PaymentIntentCancelled
            }
            fintechco::WebhookEventType::PaymentIntentAmountCapturableUpdated => {
                IncomingWebhookEvent::PaymentIntentAuthorizationSuccess
            }
            fintechco::WebhookEventType::ChargeSucceeded => {
                if let Some(fintechco::WebhookPaymentMethodDetails {
                    payment_method:
                        fintechco::WebhookPaymentMethodType::AchCreditTransfer
                        | fintechco::WebhookPaymentMethodType::MultibancoBankTransfers,
            ...
            fintechco::WebhookEventType::ChargeRefundUpdated => details
                .event_data
                .event_object
                .status
                .map(|status| match status {
                    fintechco::WebhookEventStatus::Succeeded => IncomingWebhookEvent::RefundSuccess,
                    fintechco::WebhookEventStatus::Failed => IncomingWebhookEvent::RefundFailure,
                    _ => IncomingWebhookEvent::EventNotSupported,
                })
                .unwrap_or(IncomingWebhookEvent::EventNotSupported),
            fintechco::WebhookEventType::SourceChargeable => IncomingWebhookEvent::SourceChargeable,
            fintechco::WebhookEventType::DisputeCreated => IncomingWebhookEvent::DisputeOpened,
            fintechco::WebhookEventType::DisputeClosed => IncomingWebhookEvent::DisputeCancelled,
            fintechco::WebhookEventType::DisputeUpdated => details
                .event_data
                .event_object
                .status
                .map(Into::into)
                .unwrap_or(IncomingWebhookEvent::EventNotSupported),
            fintechco::WebhookEventType::PaymentIntentPartiallyFunded => {
                IncomingWebhookEvent::PaymentIntentPartiallyFunded
            }
            fintechco::WebhookEventType::PaymentIntentRequiresAction => {
                IncomingWebhookEvent::PaymentActionRequired
            }
            fintechco::WebhookEventType::ChargeDisputeFundsWithdrawn => {
                IncomingWebhookEvent::DisputeLost
            }
            fintechco::WebhookEventType::ChargeDisputeFundsReinstated => {
                IncomingWebhookEvent::DisputeWon
            }
            fintechco::WebhookEventType::Unknown
            | fintechco::WebhookEventType::ChargeCaptured
            | fintechco::WebhookEventType::ChargeExpired
            | fintechco::WebhookEventType::ChargeFailed
            | fintechco::WebhookEventType::ChargePending
            | fintechco::WebhookEventType::ChargeUpdated
            | fintechco::WebhookEventType::ChargeRefunded
            | fintechco::WebhookEventType::PaymentIntentCreated
            | fintechco::WebhookEventType::PaymentIntentProcessing
            | fintechco::WebhookEventType::SourceTransactionCreated => {
                IncomingWebhookEvent::EventNotSupported
            }
        })
    }
...
impl ConnectorRedirectResponse for Fintechco {
    fn get_flow_type(
        &self,
        _query_params: &str,
...
impl api::Payouts for Fintechco {}
#[cfg(feature = "payouts")]
impl api::PayoutCancel for Fintechco {}
#[cfg(feature = "payouts")]
impl api::PayoutCreate for Fintechco {}
#[cfg(feature = "payouts")]
impl api::PayoutFulfill for Fintechco {}
#[cfg(feature = "payouts")]
impl api::PayoutRecipient for Fintechco {}
#[cfg(feature = "payouts")]
impl api::PayoutRecipientAccount for Fintechco {}

#[cfg(feature = "payouts")]
impl ConnectorIntegration<PoCancel, PayoutsData, PayoutsResponseData> for Fintechco {
    fn get_content_type(&self) -> &'static str {
        self.common_get_content_type()
    }
    ...
    fn get_url(
        ...
        Ok(format!(
            ...
            connectors.fintechco.base_url, transfer_id
        ))
    }
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::FintechcoConnectReversalRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fintechco::FintechcoConnectReversalResponse = res
            .response
...
#[cfg(feature = "payouts")]
impl ConnectorIntegration<PoCreate, PayoutsData, PayoutsResponseData> for Fintechco {
    fn get_content_type(&self) -> &'static str {
        self.common_get_content_type()
    }
    ...
    fn get_url(
        ...
        Ok(format!("{}v1/transfers", connectors.fintechco.base_url))
    }
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::FintechcoConnectPayoutCreateRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fintechco::FintechcoConnectPayoutCreateResponse = res
            .response
...
#[cfg(feature = "payouts")]
impl ConnectorIntegration<PoFulfill, PayoutsData, PayoutsResponseData> for Fintechco {
    fn get_content_type(&self) -> &'static str {
        self.common_get_content_type()
    }
    ...
    fn get_url(
        ...
        Ok(format!("{}v1/payouts", connectors.fintechco.base_url,))
    }
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::FintechcoConnectPayoutFulfillRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fintechco::FintechcoConnectPayoutFulfillResponse = res
            .response
...
#[cfg(feature = "payouts")]
impl ConnectorIntegration<PoRecipient, PayoutsData, PayoutsResponseData> for Fintechco {
    fn get_content_type(&self) -> &'static str {
        self.common_get_content_type()
    }
    ...
    fn get_url(
        ...
        Ok(format!("{}v1/accounts", connectors.fintechco.base_url))
    }
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::FintechcoConnectRecipientCreateRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fintechco::FintechcoConnectRecipientCreateResponse = res
            .response
...
#[cfg(feature = "payouts")]
impl ConnectorIntegration<PoRecipientAccount, PayoutsData, PayoutsResponseData> for Fintechco {
    fn get_content_type(&self) -> &'static str {
        self.common_get_content_type()
    }
    ...
    fn get_url(
        ...
        Ok(format!(
            ...
            connectors.fintechco.base_url, connector_customer_id
        ))
    }
    ...
    fn get_request_body(
        ...
        let connector_req = fintechco::FintechcoConnectRecipientAccountCreateRequest::try_from(req)?;
        Ok(RequestContent::FormUrlEncoded(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: fintechco::FintechcoConnectRecipientAccountCreateResponse = res
            .response
...
static FINTECHCO_SUPPORTED_PAYMENT_METHODS: LazyLock<SupportedPaymentMethods> = LazyLock::new(|| {
    ...
    let mut fintechco_supported_payment_methods = SupportedPaymentMethods::new();

    fintechco_supported_payment_methods.add(
    ...
    fintechco_supported_payment_methods
});

static FINTECHCO_CONNECTOR_INFO: ConnectorInfo = ConnectorInfo {
    display_name: "FintechCo",
...
static FINTECHCO_SUPPORTED_WEBHOOK_FLOWS: [common_enums::EventClass; 3] = [
    common_enums::EventClass::Payments,
    common_enums::EventClass::Refunds,
    common_enums::EventClass::Disputes,
];

impl ConnectorSpecifications for Fintechco {
    fn get_connector_about(&self) -> Option<&'static ConnectorInfo> {
        Some(&FINTECHCO_CONNECTOR_INFO)
    }

    fn get_supported_payment_methods(&self) -> Option<&'static SupportedPaymentMethods> {
        Some(&*FINTECHCO_SUPPORTED_PAYMENT_METHODS)
    }

    fn get_supported_webhook_flows(&self) -> Option<&'static [common_enums::EventClass]> {
        Some(&FINTECHCO_SUPPORTED_WEBHOOK_FLOWS)
    }
