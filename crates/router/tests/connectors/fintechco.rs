...
struct FintechcoTest;
impl ConnectorActions for FintechcoTest {}
impl utils::Connector for FintechcoTest {
    fn get_data(&self) -> types::api::ConnectorData {
        use router::connector::Fintechco;
        utils::construct_connector_data_old(
            Box::new(Fintechco::new()),
            types::Connector::Fintechco,
